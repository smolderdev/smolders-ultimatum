...
|[Async](https://modrinth.com/mod/async)|Improves entity performance by processing them in parallel using multiple CPU cores and threads.|
|[Async Pack Scan](https://modrinth.com/mod/async-pack-scan)|Fixes synchronous pack scanning by moving computation to another thread and scheduling a scan task on those events instead.|
|[AttributeFix](https://modrinth.com/mod/attributefix)|Removes arbitrary limits on Minecraft's attribute system.|
|[Auth Me](https://modrinth.com/mod/auth-me)|Authenticate yourself and re-validate your session.|
|[Axolotl Buckets](https://modrinth.com/mod/axolotl-buckets)|Shows the color and age of axolotls when in buckets.|
|[bad packets](https://modrinth.com/mod/badpackets)|Allows for packet messaging between different modding platforms.|
...
|Name|Description|
|---|---|
|[Translations for Sodium](https://modrinth.com/resourcepack/translations-for-sodium)|Adds unofficial translations for the Sodium Minecraft mod.|
...
>[!NOTE]
>Since Github would only let me upload up to 25 MB for some reason, the newest version is currently only available on Modrinth. It can be found [here](https://modrinth.com/modpack/smolders-ultimatum/version/1.0.4).
